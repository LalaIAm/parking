...
const TermsPage = () => {
  return (
    <div>
      <div className='container px-5 py-5 bg-white'>
        <h1>Terms of Service</h1>
        <p>
                  Agreement between User and parkezfine.com Welcome to parkezfine.com.</p>
              <p>
          The parkezfine.com website (the "Site") is comprised of various web
          pages operated by ParkEZFine ("ParkEZ"). parkezfine.com is offered to
          ...
          parkezfine.com constitutes your agreement to all such Terms. Please
          read these terms carefully, and keep a copy of them for your
          reference.</p><p> parkezfine.com is an E-Commerce Site.</p><p> The purpose of this
          website is to collect parking fines and fees. Electronic
          Communications Visiting parkezfine.com or sending emails to ParkEZ
          constitutes electronic communications. You consent to receive
          electronic communications and you agree that all agreements, notices,
          disclosures and other communications that we provide to you
          electronically, via email and on the Site, satisfy any legal
          requirement that such communications be in writing.</p><p> Children Under
          Thirteen ParkEZ does not knowingly collect, either online or offline,
          personal information from persons under the age of thirteen. If you
          are under 18, you may use parkezfine.com only with permission of a
          parent or guardian.</p><p> Links to Third Party Sites/Third Party Services
          parkezfine.com may contain links to other websites ("Linked Sites").
          The Linked Sites are not under the control of ParkEZ and ParkEZ is not
          ...
          updates to a Linked Site. ParkEZ is providing these links to you only
          as a convenience, and the inclusion of any link does not imply
          endorsement by ParkEZ of the site or any association with its
          operators. Certain services made available via parkezfine.com are
          delivered by third party sites and organizations. By using any
          product, service or functionality originating from the parkezfine.com
          domain, you hereby acknowledge and consent that ParkEZ may share such
          information and data with any third party with whom ParkEZ has a
          contractual relationship to provide the requested product, service or
          functionality on behalf of parkezfine.com users and customers. No
          Unlawful or Prohibited Use/Intellectual Property You are granted a
          non-exclusive, non-transferable, revocable license to access and use
          parkezfine.com strictly in accordance with these terms of use. As a
          condition of your use of the Site, you warrant to ParkEZ that you will
          ...
          damage, disable, overburden, or impair the Site or interfere with any
          ...
          intentionally made available or provided for through the Site. All
          content included as part of the Service, such as text, graphics,
          logos, images, as well as the compilation thereof, and any software
          used on the Site, is the property of ParkEZ or its suppliers and
          ...
          ParkEZ content is not for resale. Your use of the Site does not
          ...
          content without the express written permission of ParkEZ and the
          ...
          express or implied, to the intellectual property of ParkEZ or our
          licensors except as expressly authorized by these Terms. International
          Users The Service is controlled, operated and administered by ParkEZ
          ...
          local laws. You agree that you will not use the ParkEZ Content
          accessed through parkezfine.com in any country or in any manner
          ...
          ParkEZ, its officers, directors, employees, agents and third parties,
          ...
          rules or regulations. ParkEZ reserves the right, at its own cost, to
          ...
          cooperate with ParkEZ in asserting any available defenses. Arbitration
          ...
          Class Action Waiver Any arbitration under these Terms and Conditions
          ...
          Further, unless both you and ParkEZ agree otherwise, the arbitrator
          ...
          proceeding. Liability Disclaimer THE INFORMATION, SOFTWARE, PRODUCTS,
          ...
          TO THE INFORMATION HEREIN. PARKEZFINE AND/OR ITS SUPPLIERS MAY MAKE
          IMPROVEMENTS AND/OR CHANGES IN THE SITE AT ANY TIME. PARKEZFINE AND/OR
          ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE SUITABILITY,
          ...
          CONDITION OF ANY KIND. PARKEZFINE AND/OR ITS SUPPLIERS HEREBY DISCLAIM
          ...
          PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL PARKEZFINE AND/OR ITS
          ...
          OTHERWISE, EVEN IF PARKEZFINE OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED
          ...
          USING THE SITE. Termination/Access Restriction ParkEZ reserves the
          ...
          notice. To the maximum extent permitted by law, this agreement is
          governed by the laws of the State of Minnesota and you hereby consent
          to the exclusive jurisdiction and venue of courts in Minnesota in all
          ...
          agency relationship exists between you and ParkEZ as a result of this
          agreement or use of the Site. ParkEZ's performance of this agreement
          is subject to existing laws and legal process, and nothing contained
          in this agreement is in derogation of ParkEZ's right to comply with
          ...
          gathered by ParkEZ with respect to such use. If any part of this
          ...
          constitutes the entire agreement between the user and ParkEZ with
          ...
          between the user and ParkEZ with respect to the Site. A printed
          ...
          in English. Changes to Terms ParkEZ reserves the right, in its sole
          discretion, to change the Terms under which parkezfine.com is offered.
          The most current version of the Terms will supersede all previous
          versions. ParkEZ encourages you to periodically review the Terms to
          stay informed of our updates. Contact Us ParkEZ welcomes your
          questions or comments regarding the Terms: ParkEZFine 10201 Clinton
          Ave S Minneapolis, Minnesota 55420 Email Address:
          support@parkezfine.com Telephone number: 6129783398 Effective as of
          May 01, 2024
        </p>
      </div>
    </div>
